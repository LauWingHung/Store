	...
	public static void main(String[] args) throws Exception {
		...
		Authenticator authenticator = new Authenticator() {
			...
			protected PasswordAuthentication getPasswordAuthentication() {
				...
				//设置发送者的邮箱账户密码
				return new PasswordAuthentication("Admin@lau1yach.com", "admin");
			}
		};
		...
		message.setFrom(new InternetAddress("Admin@lau1yach.com"));
		// 2.2 收件人 , to:收件人 ， cc ：抄送，bcc：暗送（密送）。（模拟账号）
		message.setRecipient(RecipientType.TO, new InternetAddress("aaa@lau1yach.com"));
		// 2.3 主题
